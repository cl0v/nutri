...
main() {
  ...
  test('Title behavior after pressing nextDay 7 times with today beeing 1', () {
    final homeTitleViewModel = HomeTitleViewModel();
    homeTitleViewModel.todayIndex = 1;
    expect(homeTitleViewModel.model.title.value, equals('HOJE'));
    expect(
        homeTitleViewModel.model.title.stream,
        emitsInOrder([
  ...
  group('dayIndex |', () {
    test('For today beeing 1, if nextDay was pressed 6 times, the day should be 7', () {
    final homeTitleViewModel = HomeTitleViewModel();
    homeTitleViewModel.todayIndex = 1;
    expect(
        homeTitleViewModel.day.stream,
        emitsInOrder([
          2,3,4,5,6,7
        ]));
  ...
  test('For today beeing 2, if nextDay was pressed 7 times, the last day should be 2', () {
    final homeTitleViewModel = HomeTitleViewModel();
    homeTitleViewModel.todayIndex = 2;
    expect(
        homeTitleViewModel.day.stream,
        emitsInOrder([
          3,4,5,6,7,1,2
  ...
  test('For today beeing 3, if nextDay was pressed 7 times, the last day should be 3', () {
    final homeTitleViewModel = HomeTitleViewModel();
    homeTitleViewModel.todayIndex = 3;
    expect(
        homeTitleViewModel.day.stream,
        emitsInOrder([
          4,5,6,7,1,2,3,
  ...
  test('For today beeing 7, if nextDay was pressed 7 times, the last day should be 7', () {
    final homeTitleViewModel = HomeTitleViewModel();
    homeTitleViewModel.todayIndex = 7;
    expect(
        homeTitleViewModel.day.stream,
        emitsInOrder([
          1,2,3,4,5,6,7,
  ...
  test('O botao de nextDay deve acrescentar um ao dia', () {
    ...
    homeTitleViewModel.todayIndex = 1;
    homeTitleViewModel.nextDay();
    expect(homeTitleViewModel.day.value, 2);
  }, skip: true);
  test('O dia nunca deve ser maior que 7, quando chega a 8, vira 1', () {
    final homeTitleViewModel = HomeTitleViewModel();
    homeTitleViewModel.todayIndex = 7;
    homeTitleViewModel.nextDay();
    expect(homeTitleViewModel.day.value, 1);
  }, skip: true);
  ...
  test('O dia nunca deve ser menor que 1, quando chega a 1, vira 7', () {
    ...
    homeTitleViewModel.todayIndex = 1;
    homeTitleViewModel.previewDay()();
    expect(homeTitleViewModel.day.value, 7);
  }, skip: true);
}
